...
def kakao_login(request):
    client_id = os.environ.get("K_RESTAPI_KEY")
...
def kakao_callback(request):
    try:
        ...
        client_id = os.environ.get("K_RESTAPI_KEY")
        client_secret = os.environ.get("K_SECRET")
        redirect_uri = "http://localhost:8000/users/login/kakao/callback"
        ...
        email = account["email"]
        if email is None:
            raise KakaoException(f"Please also give me your email")
